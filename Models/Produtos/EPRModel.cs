...
{
    /// <summary>
    /// Model específico para EPR - Equipamento de Proteção Respiratória
    /// </summary>
    public class EPRModel : IProdutoBase
    {
        ...
        public string TipoEPR { get; set; } // Máscara, Respirador, etc.

        [Required(ErrorMessage = "O tipo de filtro é obrigatório.")]
        public string TipoFiltro { get; set; } // P1, P2, P3, etc.
        ...
        public CategoriaEnum Categoria => CategoriaEnum.EPR;
    }
}
